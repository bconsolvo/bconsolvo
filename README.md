...
| ----------- | ----------- | - | 
| All Videos Views | Views across all YouTube content | 1,359,511 | 
...
| [Building AI Agents with MCP and LangChain](https://youtu.be/4LcWzuiVqbg?si=b2ARwNtRVTRvnjaI) [![langchain](images/Intel-AI-Essentials_5.png)](https://youtu.be/4LcWzuiVqbg?si=b2ARwNtRVTRvnjaI) | Build your own AI agentic workflow with Langchain, LangGraph, and MCP. You can get started with an MCP math server and an MCP weather server and equip your agents with those tools. Leverage LLM models from the Llama and DeepSeek families. You can bring your own OpenAI-compatible API key and model endpoint to get started, or use the endpoints hosted on Intel Gaudi accelerators or Intel Xeon CPUs. | 355,000 | 
| [Building an LLM-Powered Chatbot with Streamlit and Hugging Face](https://youtu.be/uvSEmGUqGEk?si=5lA5Bq3whmStAxvV) [![streamlitchatbot](images/Intel-AI-Essentials_4.png)](https://youtu.be/uvSEmGUqGEk?si=5lA5Bq3whmStAxvV) | Build your own chatbot on Hugging Face with Streamlit. I will show you how to connect your OpenAI API compatible endpoint and model to a Hugging Face Space app that you can use for your own chat applications. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denvr Dataworks' cloud servers. | 466 | 
| [Drug Discovery and Building Your Own LLM Chatbot with LobeChat](https://youtu.be/iDTTD3h5rFo?si=-i9tmPEZy7KC8C0-) [![chatbot](images/Intel-AI-Essentials_3.png)](https://youtu.be/iDTTD3h5rFo?si=-i9tmPEZy7KC8C0-) | Come and build your very own LLM chatbot with LobeChat—no code required. Use the LobeChat web UI with an OpenAI API compatible endpoint.  Experiment with prompts to build a drug discovery app. The model inference endpoints are hosted on Intel Gaudi accelerators and Intel Xeon CPUs, deployed on Denvr Dataworks' cloud servers. | 254,000
| [Planning Your Next Vacation with VacAIgent and CrewAI](https://youtu.be/kMgbShdQqgE?si=nd_1tlkOMqrYfDqC) [![vacaigent](images/Intel-AI-Essentials_2.png)](https://youtu.be/kMgbShdQqgE?si=nd_1tlkOMqrYfDqC) | Plan your next vacation with AI agents. Get the costs and fetch all the relevant information from the web with modern agentic AI and LLMs. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denver Dataworks' cloud servers. | 341,000 | 
| [Generate Code for a Stock Trading Application with DeepSeek, Part 1/4](https://youtu.be/p7Sv4l_v2Mk?si=ZKBDTUdS5Qq1CTFC) [![stockpart1](images/Intel-AI-Essentials_1-A.png)](https://youtu.be/p7Sv4l_v2Mk?si=ZKBDTUdS5Qq1CTFC)| Come and learn how to generate code using DeepSeek to build a stock trading application. I showcase a Streamlit application on Hugging Face, where I have the options to run with popular models including DeepSeek, Llama, Mistral, and Falcon. It is easy to build on Intel with an OpenAI-compatible API key. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denvr Dataworks' cloud servers.| 401,000 | 
| [Generate Code for a Stock Trading Application with DeepSeek, Part 2/4](https://youtu.be/qpR_znaPjPs?si=XO-wa5WxtKFGBn3k) [![stockpart1](images/Intel-AI-Essentials_1-B.png)](https://youtu.be/qpR_znaPjPs?si=XO-wa5WxtKFGBn3k)| Come and learn how to generate code using DeepSeek to build a stock trading application. I showcase a Streamlit application on Hugging Face, where I have the options to run with popular models including DeepSeek, Llama, Mistral, and Falcon. It is easy to build on Intel with an OpenAI-compatible API key. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denvr Dataworks' cloud servers.| 262 | 
| [Generate Code for a Stock Trading Application with DeepSeek, Part 3/4](https://youtu.be/FjwmvjkwhdA?si=ZHAIKajHyfh7KYe_) [![stockpart1](images/Intel-AI-Essentials_1-C.png)](https://youtu.be/FjwmvjkwhdA?si=ZHAIKajHyfh7KYe_)| Come and learn how to generate code using DeepSeek to build a stock trading application. I showcase a Streamlit application on Hugging Face, where I have the options to run with popular models including DeepSeek, Llama, Mistral, and Falcon. It is easy to build on Intel with an OpenAI-compatible API key. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denvr Dataworks' cloud servers.| 445 | 
| [Generate Code for a Stock Trading Application with DeepSeek, Part 4/4](https://youtu.be/Z_Di7gz6TUU?si=LO1MD9AQkahtspkH) [![stockpart1](images/Intel-AI-Essentials_1-D.png)](https://youtu.be/Z_Di7gz6TUU?si=LO1MD9AQkahtspkH)| Come and learn how to generate code using DeepSeek to build a stock trading application. I showcase a Streamlit application on Hugging Face, where I have the options to run with popular models including DeepSeek, Llama, Mistral, and Falcon. It is easy to build on Intel with an OpenAI-compatible API key. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denvr Dataworks' cloud servers.| 264 | 
...
| [CNCF On demand webinar: Building Cloud Native Agentic Workflows in Healthcare with AutoGen](https://youtu.be/F38MNP9O2Rs?si=A31j7N9iPrJfh17M) [![agentsautogen](https://github.com/user-attachments/assets/bc9becb7-0524-44be-828c-8f21068eb3b9)](https://youtu.be/F38MNP9O2Rs?si=A31j7N9iPrJfh17M) | This session explores the integration of AI agents into preventative healthcare with AutoGen, an open-source agentic AI framework. The solution employs a multi-agent system connected to open-source LLMs such as Llama-3.3-70B-Instruct and DeepSeek-R1-Distill-Llama-70B. | 375 | 
