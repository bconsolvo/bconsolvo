...
| [Planning Your Next Vacation with VacAIgent and CrewAI](https://youtu.be/kMgbShdQqgE?si=vXgk8Cg0fxQcKaqT) | Plan your next vacation with AI agents. Get the costs and fetch all the relevant information from the web with modern agentic AI and LLMs. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denver Dataworks' cloud servers. | 
