...
| Link | Description | 
| ----------- | ----------- |
| [Building AI Agents with MCP and LangChain](https://youtu.be/4LcWzuiVqbg?si=b2ARwNtRVTRvnjaI) [![langchain](images/Intel-AI-Essentials_5.png)](https://youtu.be/4LcWzuiVqbg?si=b2ARwNtRVTRvnjaI) | Build your own AI agentic workflow with Langchain, LangGraph, and MCP. You can get started with an MCP math server and an MCP weather server and equip your agents with those tools. Leverage LLM models from the Llama and DeepSeek families. You can bring your own OpenAI-compatible API key and model endpoint to get started, or use the endpoints hosted on Intel Gaudi accelerators or Intel Xeon CPUs. | 
| [Building an LLM-Powered Chatbot with Streamlit and Hugging Face](https://youtu.be/uvSEmGUqGEk?si=5lA5Bq3whmStAxvV) [![streamlitchatbot](images/Intel-AI-Essentials_4.png)](https://youtu.be/uvSEmGUqGEk?si=5lA5Bq3whmStAxvV) | Build your own chatbot on Hugging Face with Streamlit. I will show you how to connect your OpenAI API compatible endpoint and model to a Hugging Face Space app that you can use for your own chat applications. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denvr Dataworks' cloud servers. |
| [Drug Discovery and Building Your Own LLM Chatbot with LobeChat](https://youtu.be/iDTTD3h5rFo?si=-i9tmPEZy7KC8C0-) [![chatbot](images/Intel-AI-Essentials_3.png)](https://youtu.be/iDTTD3h5rFo?si=-i9tmPEZy7KC8C0-) | Come and build your very own LLM chatbot with LobeChat—no code required. Use the LobeChat web UI with an OpenAI API compatible endpoint.  Experiment with prompts to build a drug discovery app. The model inference endpoints are hosted on Intel Gaudi accelerators and Intel Xeon CPUs, deployed on Denvr Dataworks' cloud servers. | 
| [Planning Your Next Vacation with VacAIgent and CrewAI](https://youtu.be/kMgbShdQqgE?si=nd_1tlkOMqrYfDqC) [![vacaigent](images/Intel-AI-Essentials_2.png)](https://youtu.be/kMgbShdQqgE?si=nd_1tlkOMqrYfDqC) | Plan your next vacation with AI agents. Get the costs and fetch all the relevant information from the web with modern agentic AI and LLMs. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denver Dataworks' cloud servers. |
| [Generate Code for a Stock Trading Application with DeepSeek, Part 1/4](https://youtu.be/p7Sv4l_v2Mk?si=ZKBDTUdS5Qq1CTFC) [![stockpart1](images/Intel-AI-Essentials_1-A.png)](https://youtu.be/p7Sv4l_v2Mk?si=ZKBDTUdS5Qq1CTFC)| Come and learn how to generate code using DeepSeek to build a stock trading application. I showcase a Streamlit application on Hugging Face, where I have the options to run with popular models including DeepSeek, Llama, Mistral, and Falcon. It is easy to build on Intel with an OpenAI-compatible API key. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denvr Dataworks' cloud servers.| 
| [Planning Your Next Vacation with VacAIgent and CrewAI](https://youtu.be/kMgbShdQqgE?si=vXgk8Cg0fxQcKaqT) [![vacaigent](images/Intel-AI-Essentials_2.png)](https://youtu.be/kMgbShdQqgE?si=vXgk8Cg0fxQcKaqT) | Plan your next vacation with AI agents. Get the costs and fetch all the relevant information from the web with modern agentic AI and LLMs. The model inference endpoints are hosted on Intel Gaudi or Intel Xeon and deployed on Denver Dataworks' cloud servers. | 
